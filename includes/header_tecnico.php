<?php
// includes/header_tecnico.php
// Cabeçalho reutilizável para área do técnico/fisioterapeuta

requirePerfil('tecnico');
$nome_tecnico = h($_SESSION['nome'] ?? 'Técnico');
?>
<!DOCTYPE html>
<html lang="pt">
<head>
    ...
    <title>RehabLink | <?= h($pagina_titulo ?? 'Técnico') ?></title>
    ...
    <link rel="stylesheet" href="<?= APP_URL ?>/public/assets/css/fisioterapeuta.css">
...
<body>
    <header class="topbar d-flex justify-content-between align-items-center px-4 py-3">
        <div class="sistema-nome">
            <a href="<?= APP_URL ?>/private/tecnico/index_F.php" class="text-decoration-none d-flex align-items-center gap-3">
