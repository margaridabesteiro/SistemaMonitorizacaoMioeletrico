<?php
// Admin: anonimizar utilizador — RGPD Art.17 "Direito a ser esquecido"
...
// Confirmar que não é o próprio admin a anonimizar-se
...
// Anonimizar dados pessoais (mantém dados clínicos — obrigação legal de retenção)
...
try {
    ...
    // Marcar pedido de eliminação como processado (se existir)
