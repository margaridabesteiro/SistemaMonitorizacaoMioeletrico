...
$pagina_titulo = 'Meu Perfil'; $pagina_ativa = 'perfil';
$db = getDB(); $uid = (int)$_SESSION['utilizador_id'];
$stmt = $db->prepare("
    SELECT u.*, p.especialidade, p.instituicao, p.contacto, p.numero_ordem
    FROM utilizadores u
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="card p-3 text-center mb-3">
                        <i class="fa-solid fa-user-doctor fa-3x mb-2" style="color:#8B0000;"></i>
                        <h4><?= h($user['nome']) ?></h4>
