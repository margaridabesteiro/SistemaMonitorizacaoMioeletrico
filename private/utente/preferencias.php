...
$pagina_titulo = 'Preferências'; $pagina_ativa = 'perfil';
...
if (!$prefs) {
    $db->prepare('INSERT INTO preferencias_utilizador (utilizador_id) VALUES (?)')->execute([$uid]);
    $prefs = ['notif_email'=>1,'notif_inicio_sessao'=>1,'idioma'=>'pt'];
}
        ...
        <main class="content">
            ...
            <div class="card p-4" style="max-width:500px;">
                <form method="POST">
                    ...
                    <hr>
                    <h5 class="mb-3 mt-3">Idioma</h5>
                    <div class="d-flex align-items-center gap-2 mb-4">
                        <span class="badge bg-primary py-2 px-3">PT — Português (PT)</span>
                        <small class="text-muted">Apenas PT disponível</small>
                    </div>
                    <button type="submit" class="btn w-100" style="background:#667eea;color:#fff;"><i class="fa-solid fa-floppy-disk me-1"></i>Guardar Alterações</button>
                </form>
            </div>
        </main>
