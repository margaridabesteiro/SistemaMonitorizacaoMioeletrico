...
<iframe src="<?php echo APP_URL; ?>/private/tecnico/jogos/claw_game.html?v=<?php echo filemtime(__DIR__.'/claw_game.html'); ?>" style="width:100%;height:calc(100vh - 42px);border:none;"></iframe>
</body></html>
