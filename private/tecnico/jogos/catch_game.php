...
<div style="padding:10px;background:#1a5f8a;color:#fff;font-family:sans-serif;">
  ...
  <span style="margin-left:20px;font-weight:bold;"><?php echo ucwords('catch game'); ?></span>
</div>
<iframe src="<?php echo APP_URL; ?>/private/tecnico/jogos/catch_game.html" style="width:100%;height:calc(100vh - 42px);border:none;"></iframe>
</body></html>
